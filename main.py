...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/AndySX25") ],
                    [
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[AndySX](https://t.me/AndySX25)"
    if raw_text3 == '1':
        CR = '[AndySX](https://t.me/AndySX25)'
    elif raw_text3:
        try:
    ...
    await editable.edit("**Enter PW Token For PW Uploading or Send `3` For Others.**")
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
             ...
             headers = {'Host': 'api.classplusapp.com', 'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..wGX0KWNcZT1D78CxnUiJN3Kv1MLqvB1vx3bkswxLMsOBUvJNUwsWa6PiQuhnhsIc', 'user-agent': 'Mobile-Android', 'app-version': '1.4.37.1', 'api-version': '18', 'device-id': '5d0d17ac8b3c9f51', 'device-details': '2848b866799971ca_2848b8667a33216c_SDK-30', 'accept-encoding': 'gzip'}
             params = (('url', f'{url}'),)
